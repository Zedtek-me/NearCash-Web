...
export default function SignUp(){
    ...
    return (
        <form method="post" onSubmit={async (e)=> await handleSubmit(e, setLoading, data, "signup")} className="flex flex-col justify-around items-center justify-self-start text-center text-black h-full w-2/3">
            <div className="email flex flex-row flex-wrap justify-around items-center w-1/2 h-12 shadow rounded-3xl">
                <label htmlFor="email" className="text-left flex flex-row justify-center items-center mr-3">First Name</label>
                <input type="email" name="email" id="email" onChange={(e)=> handleState(e, setData)} className="text-black text-center w-2/3 active:outline-none active:border-none focus:outline-none focus:border-none" placeholder="johndoe@email.com"/>
            </div>
            <div className="password flex flex-row flex-wrap  justify-around items-center w-1/2 h-12 shadow rounded-3xl">
                <label htmlFor="password" className="text-left flex flex-row justify-center items-center mr-3">Last Name</label>
                <input type="password" name="password" id="password" onChange={(e)=> handleState(e, setData)} className="text-center text-black w-2/3 active:outline-none active:border-none focus:outline-none focus:border-none" placeholder="************"/>
            </div>
            <div className="password flex flex-row flex-wrap  justify-around items-center w-1/2 h-12 shadow rounded-3xl">
                <label htmlFor="password" className="text-left flex flex-row justify-center items-center mr-3">Email</label>
                <input type="password" name="password" id="password" onChange={(e)=> handleState(e, setData)} className="text-center text-black w-2/3 active:outline-none active:border-none focus:outline-none focus:border-none" placeholder="************"/>
            </div>
            <div className="password flex flex-row flex-wrap  justify-around items-center w-1/2 h-12 shadow rounded-3xl">
