...
export default function Login(){
    ...
    return (
        <form method="post" onSubmit={ async (e)=> await handleSubmit(e, setLoading, data, "login")} className="flex flex-col justify-around items-center justify-self-start text-center text-black h-full w-2/3">
