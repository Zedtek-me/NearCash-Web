            ...
            {!isEditing ? (
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-white text-black border-2 border-black rounded-lg hover:bg-gray-50 transition-all"
                >
                  <X size={18} />
                  Cancel
                </button>
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <h3 className="text-2xl font-bold text-black mb-1">
                {formData.fullName || formData.firstName || 'User'}
              </h3>
